...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt = $conn->prepare("INSERT INTO movies (title, genre, duration, showtime) VALUES (?, ?, ?, ?)");
    $stmt->bind_param("ssis", $title, $genre, $duration, $showtime);
...
<body>
    ...
    <div class="container">
        <?php if (isset($success)): ?>
            <div class="message success"><?php echo $success; ?> <a href="dashboard.php">Go back to dashboard</a></div>
        <?php endif; ?>
